...
Além disso, utilizaremos a função `bintree.R` para a obter a árvore binomial básica do ativo:
```{r eval=T}
source("bintree.R")
```
<br>
...
Em seguida, vamos aplicar a função `bintree.R` para cálculo da árvore binomial, considerando:
